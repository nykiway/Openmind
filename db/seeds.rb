...
meditation = EzDownload.open('https://openmind-seeds.s3-us-west-1.amazonaws.com/Acceptance+%26+Letting+Go.mp3')
...
meditation = EzDownload.open('https://openmind-seeds.s3-us-west-1.amazonaws.com/Aid+with+Anxiety+%26+Stress.mp3')
...
meditation = EzDownload.open('https://openmind-seeds.s3-us-west-1.amazonaws.com/Appreciate+Nature.mp3')
...
meditation = EzDownload.open('https://openmind-seeds.s3-us-west-1.amazonaws.com/Become+Sleepy.mp3')
...
meditation = EzDownload.open('https://openmind-seeds.s3-us-west-1.amazonaws.com/Breathe.mp3')
...
meditation = EzDownload.open('https://openmind-seeds.s3-us-west-1.amazonaws.com/Breathing+Meditation+for+Kids.mp3')
...
meditation = EzDownload.open('https://openmind-seeds.s3-us-west-1.amazonaws.com/Experience+Your+Food.mp3')
...
meditation = EzDownload.open('https://openmind-seeds.s3-us-west-1.amazonaws.com/Get+More+From+Your+Workout.mp3')
...
meditation = EzDownload.open('https://openmind-seeds.s3-us-west-1.amazonaws.com/Getting+a+Good+Nights+Rest.mp3')
...
meditation = EzDownload.open('https://openmind-seeds.s3-us-west-1.amazonaws.com/Impatience.mp3')
...
meditation = EzDownload.open('https://openmind-seeds.s3-us-west-1.amazonaws.com/Kindness+How+to+be+nicer+to+yourself.mp3')
...
meditation = EzDownload.open('https://openmind-seeds.s3-us-west-1.amazonaws.com/Learn+Patience.mp3')
...
meditation = EzDownload.open('https://openmind-seeds.s3-us-west-1.amazonaws.com/Let+Go+of+Stress.mp3')
...
meditation = EzDownload.open('https://openmind-seeds.s3-us-west-1.amazonaws.com/Meditation+for+Gratitude.mp3')
...
meditation = EzDownload.open('https://openmind-seeds.s3-us-west-1.amazonaws.com/Meditation+for+Stress.mp3')
...
meditation = EzDownload.open('https://openmind-seeds.s3-us-west-1.amazonaws.com/Meditation+for+Two.mp3')
...
meditation = EzDownload.open('https://openmind-seeds.s3-us-west-1.amazonaws.com/Obstacles+%26+Doubt.mp3')
...
meditation = EzDownload.open('https://openmind-seeds.s3-us-west-1.amazonaws.com/Positive+Day+Meditation.mp3')
...
meditation = EzDownload.open('https://openmind-seeds.s3-us-west-1.amazonaws.com/Reflection+-+Sunday+Scaries.mp3')
...
meditation = EzDownload.open('https://openmind-seeds.s3-us-west-1.amazonaws.com/Self+Care+-+Sunday+Scaries.mp3')
...
meditation = EzDownload.open('https://openmind-seeds.s3-us-west-1.amazonaws.com/Setting+Intentions+-+Sunday+Scaries.mp3')
...
meditation = EzDownload.open('https://openmind-seeds.s3-us-west-1.amazonaws.com/Unwind.mp3')
